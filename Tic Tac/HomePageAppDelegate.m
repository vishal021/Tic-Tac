...
#import "HomePageAppDelegate.h"

#import "HomePageViewController.h"

@implementation HomePageAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[[HomePageViewController alloc] initWithNibName:@"HomePageViewController" bundle:nil] autorelease];
